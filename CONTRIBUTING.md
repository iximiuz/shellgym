...
ShellGym is distributed under the [PolyForm Noncommercial License 1.0.0](LICENSE.md), which
does not permit commercial use. To keep commercial licensing of ShellGym possible, contributions
...
ShellGym as a whole. You retain the copyright to your contribution and the right to use it for
any other purpose.
