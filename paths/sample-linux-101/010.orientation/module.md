...
Most units take under a minute. When a unit is complete, the panel moves
on to the next one automatically. You can always look back with the arrows
in the toolbar or jump around from the map.
